These notes are for the EDITORS of RBO
...
Make sure you have an ID range in the [idranges file](RBO-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [RBO-edit.owl](RBO-edit.owl)

** DO NOT EDIT RBO.obo OR RBO.owl in the top level directory **

[../../RBO.owl](../../RBO.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/DanBerrios/RBO) for details.
 ...
 * [RBO-idranges.owl](RBO-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/RBO_terms.txt file
...
Note: the RBO_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as RBO.owl and RBO.obo and places
 ...
 * https://github.com/DanBerrios/RBO/releases
 * https://github.com/DanBerrios/RBO/releases/new
...
what is in the `owl:versionIRI` of the derived RBO.owl (`data-version` in
RBO.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/RBO.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/RBO/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/DanBerrios/RBO.svg?branch=master)](https://travis-ci.org/DanBerrios/RBO)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/DanBerrios](https://travis-ci.org/profile/DanBerrios)
 2. click the "Sync account" button
 3. Click the tick symbol next to RBO
