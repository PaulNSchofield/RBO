 ...
 * [RBO.yml](RBO.yml)
     * Determines how your purl.obolibrary.org/obo/RBO/ redirects will be handled
     ...
     * Paste in the contents of [RBO.yml](RBO.yml)
 ...
 * [RBO.md](RBO.md)
     ...
     * Paste in the contents of [RBO.md](RBO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
